...
Original file is located at
    https://colab.research.google.com/drive/1tCr0TevsiF4wg6QvCy3XSxJW-6aa59nR
...
fig = px.pie(labels=biology.index, values=biology.values, names=biology.index, title='Percentage of Male vs. Female Winners', hole=0.6)
...
df_data[df_data.sex == "Female"].sort_values('year', ascending=False)[:3]
# They won the prize for Literature, Physics, Chemistry
# USA, USA, France
...
categories = df_data.drop_duplicates(subset=['category'])['category']
categories_v2 = df_data['category'].value_counts()
categories_v2

fig = px.bar(
    x=categories_v2.index,
    y=categories_v2.values,
    title="Number of Prizes awarded by Category",
    color=categories_v2.values,
...
prizes_by_categories_biology = df_data.groupby(['category','sex'],as_index=False).agg({"prize":"count"})
prizes_by_categories_biology.sort_values('prize', ascending=False, inplace=True)

fig = px.bar(
    x = prizes_by_categories_biology.category,
    y = prizes_by_categories_biology.prize,
    color = prizes_by_categories_biology.sex,
...
# 4 women in Physics and 16 in Literature
...
print(f"The youngest Nobel laureate: {df_data['full_name'].loc[df_data['winning_age'].idxmin()]}, {df_data['motivation'].loc[df_data['winning_age'].idxmin()][1:-2]}, at the age of {int(df_data['winning_age'].min())}")
print(f"The oldest Nobel laureate: {df_data['full_name'].loc[df_data['winning_age'].idxmax()]}, {df_data['motivation'].loc[df_data['winning_age'].idxmax()][1:-2]}, at the age of {int(df_data['winning_age'].max())}")
