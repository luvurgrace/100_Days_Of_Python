...
Original file is located at
    https://colab.research.google.com/drive/1Fg97XCS-uQxs4zylEG5QFhT2vVMc5Bat
...
rgb_colours = colors["name"].nunique() # unique rgb
print(f'Unique rgb colours: {rgb_colours}')
unique_colors = len(set(colors['name']))
print(f'Unique rgb colours: {unique_colors}')
uniq_colors_rgb = colors['name'].drop_duplicates().shape[0]
print(f'Unique rgb colours: {uniq_colors_rgb}')
